...
public class AddUpdateDeletePlayer extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGap(28, 28, 28)
                                                .addComponent(phone, javax.swing.GroupLayout.PREFERRED_SIZE, 244,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(86, 86, 86)
                                                .addComponent(jLabel19, javax.swing.GroupLayout.PREFERRED_SIZE, 180,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(33, 33, 33)
                                                .addComponent(team_id, javax.swing.GroupLayout.PREFERRED_SIZE, 244,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(player_id, javax.swing.GroupLayout.Alignment.TRAILING,
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(4, 4, 4)
                                                .addComponent(jLabel11))
                                        .addComponent(player_name, javax.swing.GroupLayout.PREFERRED_SIZE, 34,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(13, 13, 13)
                                                .addComponent(jLabel16))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(9, 9, 9)
                                                .addComponent(role, javax.swing.GroupLayout.PREFERRED_SIZE, 34,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(50, 50, 50)
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(phone, javax.swing.GroupLayout.PREFERRED_SIZE, 34,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 13,
                                        Short.MAX_VALUE)
                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 257,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_saveActionPerformed
        ...
        String joiningDate = since.getText();
        ...
        try {
            ...
            st.executeUpdate("insert into player values('" + playerid + "', '" + playerName + "', '" + addr + "', '"
                    + phon + "', '" + birthDate + "', '" + rol + "', '" + joiningDate + "', '" + sal + "', '" + teamid
                    + "')");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            pst = con.prepareStatement(
                    "update player set name = ?, address = ? , phone_no = ?, dob = ?, role = ?, since = ?, salary= ?, team_id = ? where player_id = ?");
    ...
    private void tblPlayerMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tblPlayerMouseClicked
        ...
        dob.setText(d.getValueAt(selectIndex, 4).toString());
        // dob.setDate(date);
        ...
        // try {
        // java.util.Date date = new SimpleDateFormat("yyyy-MM-dd").parse((String)
        since.setText(d.getValueAt(selectIndex, 6).toString());
        // since.setDate(date);
        // } catch (ParseException ex) {
        // Logger.getLogger(AddUpdateDeletePlayer.class.getName()).log(Level.SEVERE,
        // null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddUpdateDeletePlayer.class.getName())
